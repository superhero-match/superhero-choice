...
dkb:
	docker build -t superhero-choice .

dkr:
	docker run -p "4100:4100" -p "8130:8130" superhero-choice

launch: dkb dkr

api-log:
	docker logs superhero-choice -f
...
api-ssh:
	docker exec -it superhero-choice /bin/bash
